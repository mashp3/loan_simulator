  ...
  Widget _buildPrivacyPolicyContent() {
    return Column(
      ...
      children: [
        ...
        _buildSubSection('1.2 広告サービスが収集する情報', [
          '本アプリでは、無料版において広告配信のために第三者の広告サービスを使用しています。これらのサービスは、以下の情報を自動的に収集する場合があります：',
          '• 広告ID',
          '• デバイス情報（機種、OS、バージョン）',
          '• IPアドレス',
          '• アプリの使用状況',
          '• 広告の表示・クリック情報',
          '',
          '注： プレミアム版（有料版）を購入されたユーザーには広告が表示されないため、広告サービスによる情報収集は行われません。',
        ]),
        ...
        _buildSubSection('3.1 広告配信サービス（無料版のみ）', [
          'Google AdMob',
          'これらのサービスは独自のプライバシーポリシーに基づいて情報を収集・使用します。詳細は各サービスのプライバシーポリシーをご確認ください：',
          'Google AdMobのプライバシーポリシー: https://policies.google.com/privacy',
        ]),
        _buildSubSection('3.2 決済サービス', [
          'Google Play 課金システム',
          'すべての購入処理はGoogle Playの決済システムを通じて行われます。Google Playのプライバシーポリシーについては、以下をご確認ください：',
          'Google Playのプライバシーポリシー: https://policies.google.com/privacy',
        ]),
        _buildSection('4. アプリ内課金について', [
          '本アプリでは、以下の有料機能を提供しています：',
          '• 広告の非表示化',
          '• プレミアム機能の利用',
        ]),
        _buildSubSection('4.1 決済情報', [
          'すべての購入処理はGoogle Playの決済システムを通じて行われます。当方は、クレジットカード番号などの決済情報を直接収集・保存することはありません。',
        ]),
        _buildSubSection('4.2 購入状態の管理', [
          '購入状態を確認するため、Google Playから提供される購入トークンをデバイス内に保存します。この情報は外部に送信されることはありません。',
        ]),
        _buildSection('5. 広告のパーソナライズ設定（無料版のみ）', [
          'ユーザーは、デバイスの設定から広告のパーソナライズをオプトアウト（無効化）することができます：',
          '',
          'Android端末の場合:',
          '設定 → Google → 広告 → 「広告のパーソナライズをオプトアウト」を有効化',
        ]),
        _buildSection('6. データの削除', [
          '本アプリをアンインストールすることで、デバイス内に保存されたすべてのデータ（計算結果、設定情報など）が削除されます。',
        ]),
        _buildSection('7. 情報の第三者提供', [
          '当方は、法令に基づく場合を除き、ユーザーの同意なく第三者に個人情報を提供することはありません。ただし、広告サービスが独自に収集する情報については、各サービスのプライバシーポリシーに従います。',
        ]),
        _buildSection('8. セキュリティ', [
          '本アプリで入力・保存されたデータは、デバイス内でのみ処理され、外部に送信されることはありません。データの安全性はお使いのデバイスのセキュリティに依存します。',
        ]),
        _buildSection('9. お子様のプライバシー', [
          '本アプリは13歳未満のお子様を対象としておらず、意図的に13歳未満の子供から個人情報を収集することはありません。',
        ]),
        _buildSection('10. プライバシーポリシーの変更', [
          '本ポリシーの内容は、法令の変更やサービスの改善に伴い、予告なく変更される場合があります。変更後のプライバシーポリシーは、本ページに掲載した時点で効力を生じるものとします。',
        ]),
        _buildSection('11. お問い合わせ', [
          '本ポリシーに関するご質問やご意見は、以下の連絡先までお問い合わせください。',
          '',
          'Email: mash.37@icloud.com',
        ]),
        SizedBox(height: 20),
        Text(
          '最終更新日: 2025年10月13日',
